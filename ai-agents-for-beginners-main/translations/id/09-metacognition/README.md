...
- Transparansi: Memastikan bahwa sistem AI dapat menjelaskan alasan dan keputusan mereka.
...
Contoh: "Saya mengutamakan penerbangan yang lebih murah karena… saya mungkin melewatkan penerbangan langsung, jadi saya akan memeriksa ulang."
Melacak bagaimana atau mengapa memilih rute tertentu.
- Mencatat bahwa ia membuat kesalahan karena terlalu mengandalkan preferensi pengguna dari waktu sebelumnya, sehingga mengubah strategi pengambilan keputusannya, bukan hanya rekomendasi akhir.
- Mendiagnosis pola seperti, "Setiap kali saya melihat pengguna menyebut 'terlalu ramai,' saya tidak hanya harus menghapus atraksi tertentu tetapi juga mencerminkan bahwa metode saya memilih 'atraksi teratas' salah jika saya selalu memeringkatkan berdasarkan popularitas."
...
- Refleksi Diri: Agen dapat menilai kinerja mereka sendiri dan mengidentifikasi area yang perlu perbaikan.
...
- Manajemen Sumber Daya: Agen dapat mengoptimalkan penggunaan sumber daya, seperti waktu dan kekuatan komputasi, dengan merencanakan dan mengevaluasi tindakan mereka.
...
**Contoh**:
Pertimbangkan agen perjalanan, layanan agen yang tidak hanya merencanakan liburan Anda tetapi juga menyesuaikan jalurnya berdasarkan data real-time dan pengalaman perjalanan pelanggan sebelumnya.
...
- **Refleksi Diri**: Agen dapat menganalisis kinerjanya dan mengidentifikasi area yang perlu perbaikan.
- **Adaptabilitas**: Agen dapat memodifikasi strategi berdasarkan umpan balik dan perubahan kondisi.
- **Koreksi Kesalahan**: Agen dapat secara mandiri mendeteksi dan memperbaiki kesalahan.
...
- **Sumber Daya yang Diperlukan**: Identifikasi sumber daya yang diperlukan.
- **Pengalaman**: Manfaatkan pengalaman masa lalu untuk menginformasikan perencanaan.

**Contoh**:
Berikut adalah langkah-langkah yang harus diambil Agen Perjalanan untuk membantu pengguna merencanakan perjalanan mereka secara efektif:
...
- **Rencana Disempurnakan**: Agen perjalanan mengiterasi rencana tersebut, mengoptimalkan berdasarkan preferensi dan anggaran klien.
...
- Sebagai teknik prompting, RAG melibatkan perumusan kueri atau prompt khusus untuk mengarahkan pengambilan informasi relevan dari korpus besar atau basis data. Informasi ini kemudian digunakan untuk menghasilkan respons atau tindakan.
...
- Sebagai alat, RAG adalah sistem terintegrasi yang mengotomatisasi proses pengambilan dan generasi, memudahkan pengembang untuk mengimplementasikan fungsi AI kompleks tanpa perlu menyusun prompt secara manual untuk tiap kueri.
...
Bergabunglah dengan [Microsoft Foundry Discord](https://discord.com/invite/ATgtXmAS5D) untuk bertemu dengan pembelajar lain, menghadiri jam kantor dan mendapatkan jawaban atas pertanyaan AI Agents Anda.
